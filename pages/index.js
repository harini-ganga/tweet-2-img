...
function App() 
{
    ...
    return (
        <Box>
            ...
            <footer>
                <Text px='1rem' className='i' color='gray.500' fontSize='lg'>Made with 💜 for open source by <a href="https://github.com/harini-ganga" rel="noreferrer" target='_blank'>Harini</a>. Check out on <a href="https://github.com/harini-ganga/tweet-2-img" rel="noreferrer" target='_blank'>Github</a>.</Text>
            </footer>
      </Box>
    )
